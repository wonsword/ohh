...
const REF = 'https://xn--v92b7yba209gttbpx5b.com/upload/lawyer';

export const lawyers: Lawyer[] = [
  {
    id: 'ko-young-seok', name: '고영석', title: '총괄센터장', priority: 1,
    headline: '부장판사를 역임하며 갖추게 된 관록과 통찰력으로 의뢰인께 가장 나은 선택을 제시해드리겠습니다.',
    fields: ['형사', '민사', '행정'],
    badges: ['부장판사', '형사센터장'],
    image: `${REF}/202412180039320702`,
    education: ['서울 한성고등학교', '서울대학교 법학과', '서울대학교 대학원 상법학 수료', '제26회 사법시험 합격', '제16기 사법연수원 수료'],
    career: ['서울남부지방법원 부장판사(형사)', '인천지방법원 부장판사(민·형사)', '대법원 재판연구관(민·형사·행정)', '서울고등법원 판사', '서울서부지방법원 판사(민·형사)', '서울중앙지방법원 형사부 판사', '정부법무공단 변호사실장', '법무법인 오현 형사사건센터장'],
  },
  {
    id: 'lee-yong', name: '이용', title: '총괄센터장', priority: 2,
    headline: '부장검사, 판사 및 지청장의 경력과 노하우를 기반으로 법률적 조력이 필요한 분들을 위한 든든한 방패막이 되겠습니다.',
    fields: ['형사', '군형사·징계', '경제범죄'],
    badges: ['부장검사', '지청장'],
    image: `${REF}/202412231704043459`,
    education: ['경기고등학교', '서울대학교 법과대학', '서울대학교 법률전문대학원 형사법전공 박사졸업', '사법시험 30회 수석합격 (사법연수원 20기)'],
    career: ['서울민사지방법원 판사', '서울지방검찰청 검사', '대검찰청 연구관', '부산지방검찰청 외사부장', '서울남부지방검찰청 형사1부장', '서울고등검찰청 부장검사', '전주지방검찰청 군산지청장', '대전지방검찰청 홍성지청장', '서울중앙지방검찰청 중요경제범죄조사 2단 단장 (2021.8. 퇴임)', '중앙대학교 법학전문대학원 겸임교수'],
  },
  {
    id: 'hwang-gyu-ryeon', name: '황규련', title: '총괄센터장', priority: 3,
    headline: '검사생활을 통해 얻은 깊은 통찰력으로 의뢰인의 권리를 지켜드리겠습니다.',
    fields: ['형사', '경제범죄', '성범죄', '이혼·가사·상속'],
    badges: ['검사', '부동산'],
    image: `${REF}/202412231705592465`,
    education: ['서울대학교 법과대학'],
    career: ['서울지검 의정부지방검찰청 검사', '대구지방검찰청 김천지청 검사', '창원지방검찰청 검사', '법무법인 예일 대표변호사', '법무법인 오현 형사사건센터장'],
  },
  {
    id: 'yang-je-min', name: '양제민', title: '변호사', priority: 4,
    headline: '증거는 사건의 결과를 바꿀 수 있는 중요한 열쇠입니다. 오현은 자체 포렌식센터를 운영하여 공학박사 출신의 변호사가 사건에 알맞은 증거를 복원 및 분석합니다.',
    fields: ['형사', '디지털포렌식'],
    badges: ['공학박사', '포렌식센터장'],
    image: `${REF}/202412241015348536`,
    education: ['인하대학교 정보통신대학원 정보통신공학과 박사'],
    career: ['인하대학교 겸임교수', '법무법인 오현 형사사건센터장', '디지털 증거분석 센터장', '한국마약범죄학회 자문', '국가인권위원회 자문'],
  },
  {
    id: 'kim-han-sol', name: '김한솔', title: '변호사', priority: 5,
    headline: '오현만의 실무노하우를 보여드리겠습니다. 형사사건은 변호사의 실무경험과 치밀한 대처방법이 매우 중요합니다.',
    fields: ['형사', '이혼·가사·상속', '성범죄'],
    badges: ['형사전문', '가사전문'],
    image: `${REF}/202412241023181671`,
    education: [],
    career: ['서울지방변호사회 이사', '서울지방변호사회 상임관리이사', '서울소방재난본부 자문변호사', '법무법인 YK 형사전문 변호사', '법무법인 오현 총괄책임변호사'],
  },
  {
    id: 'yu-kyung-su', name: '유경수', title: '변호사', priority: 6,
    headline: '경험과 전문성을 바탕으로, 의뢰인께 실질적인 도움을 드리겠습니다.',
    fields: ['형사', '이혼·가사·상속', '군형사·징계'],
    badges: ['형사전문', '가사전문'],
    image: `${REF}/202412241032529006`,
    education: ['고려대학교 법과대학'],
    career: ['군법무관', '인천지방법원 국선변호인', '대한변호사협회 인증 형사법 전문 변호사', '대한변호사협회 인증 가사법 전문 변호사', '인천지방변호사회 이사', '법무법인 오현 형사전문 변호사'],
  },
  {
    id: 'jeong-do-hun', name: '정도훈', title: '변호사', priority: 7,
    headline: '기업법률, 부동산 및 형사 분야에서 전문가로서, 많은 성공사례 및 다양한 경험을 바탕으로 의뢰인이 원하는 결과를 만들어 드리겠습니다.',
    fields: ['형사', '부동산', '기업법무·M&A'],
    badges: ['기업', '부동산'],
    image: `${REF}/202412241034503734`,
    education: [],
    career: ['서울지방변호사회 이사', '법무법인 지혁', '중앙대학교 인권센터 외부 위원', '법무법인 오현 형사전문 변호사'],
  },
  {
    id: 'roh-phil-lip', name: '노필립', title: '변호사', priority: 8,
    headline: '막연하고 두려운 형사절차, 저희만의 경험과 노하우로 명확한 분석과 서비스를 제공해드리겠습니다. 의뢰인의 막막한 길을 끝까지 함께 걸어갑니다.',
    fields: ['형사', '이혼·가사·상속'],
    badges: ['형사전문', '이혼전문'],
    image: `${REF}/202412241036242756`,
    education: ['한양대학교 경영학부 졸업(수석)'],
    career: ['국방부 고등군사법원 수료', '서울지방변호사회 법제위원', '대한변호사협회 북한인권특별위원회 위원', '대법원 국선변호인', '대한변호사협회 인증 형사전문변호사', '대한변호사협회 인증 이혼전문변호사'],
  },
  {
    id: 'park-chan-min', name: '박찬민', title: '변호사', priority: 9,
    headline: '복잡하고 불안한 송사, 그 과정을 함께하며 최적의 솔루션을 제시하겠습니다.',
    fields: ['형사', '경제범죄', '이혼·가사·상속', '부동산'],
    badges: ['형사전문', '다분야'],
    image: `${REF}/202412241038293650`,
    education: ['대원외국어고등학교', '연세대학교 경제학 학사', '서강대학교 법학 석사'],
    career: ['법무법인(유한) 대륙아주', '대한변호사협회 등록 형사전문변호사', '심리상담사 1급', '법무법인 오현'],
  },
];
